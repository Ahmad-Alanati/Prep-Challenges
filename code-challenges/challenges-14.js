...
const replaceWords = (str) => {
    ...
    replaced.indexOf('I') != -1 ? replaced.splice(replaced.indexOf('I'), 1, 'We') : null;
    replaced.indexOf('am') != -1 ? replaced.splice(replaced.indexOf('am'), 1, 'are') : null;
    replaced.indexOf('was') != -1 ? replaced.splice(replaced.indexOf('was'), 1, 'were') : null;
