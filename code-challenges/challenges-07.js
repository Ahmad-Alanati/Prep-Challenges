...
const objLat = (obj) => {
    ...
    let text = `my name is ${obj.firstName[0].toUpperCase() + obj.firstName.substring(1, obj.firstName.length)} ${obj.lastName[0].toUpperCase() + obj.lastName.substring(1, obj.lastName.length)} I am ${obj.age} YO, and I love ${obj.hobby}.`
  return text;
};
// -------------------------------------------------------------------------------------------------------
